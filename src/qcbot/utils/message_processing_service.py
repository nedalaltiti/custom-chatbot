    ...
    async def process_message_with_streaming(
        ...
        try:
            ...
            if resource_matches:
                ...
                activity_id = await self.teams_adapter.send_message(service_url, conv_id, reply_text)
    ...
    async def _fallback_to_traditional_processing(
        ...
        try:
            ...
            if result.is_success():
                ...
                activity_id = await self.teams_adapter.send_message(service_url, conv_id, answer)
