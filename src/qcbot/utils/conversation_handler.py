...
class ConversationHandler:
    ...
    def __init__(self, feedback_service: FeedbackService, teams_adapter: TeamsAdapter, message_service: MessageService, session_service):
        ...
        if (greet_only or user_payload) and not state.get("awaiting_more_help"):
            ...
            if should_show_greeting:
                ...
                if user_payload:
                    ...
                    activity_id = await self.teams_adapter.send_message(service_url, conv_id, "Hello again! How can I help you today?")
                    ...
                    # Send message and get Teams activity ID
                    activity_id = await self.teams_adapter.send_message(service_url, conv_id, "I am here to assist with your inquiries. How can I help you today?")
