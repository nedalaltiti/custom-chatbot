...
class ContentClassificationService:
    ...
    async def analyze_conversation_flow(
        ...
        """
        Analyze conversation flow with enhanced informational response handling.
...
- HR abbreviations or terms: "PTO", "401k", "FMLA", etc.
...
Confidence: 0.90
Reason: Single word that could be asking about benefits - continue conversation
...
Analyze the message:"""
    ...
    def _get_crisis_response_message(self) -> str:
        """
        Get generic crisis response message (no region-specific logic).
        """
        try:
            ...
            # Generic guidance for all users
            crisis_guidance = (
